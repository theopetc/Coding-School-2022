...
namespace Session_05
{
    ...
    internal class ConvertToBinary : ActionResolver
    {
        ...
        {//Why does it require override keyword if it's the only implementation
    ...
    //internal class Uppercase : ActionResolver
    //{
    ...
    //internal class Reverse : ActionResolver
    //{
    //    public ActionResponse Execute(ActionRequest request)
    //    {
    //        var response = new ActionResponse();
